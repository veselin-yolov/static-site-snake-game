...
<!-- /Header -->
<h1>ИЗБЕРИ СИ ИГРА</h1>
<!-- Section1 -->
<section>
	<div class="up">
		<h2><span class="font-effect-neon">X-BOOKS</span> ИГРИ С НАЙ-ВИСОКА ОЦЕНКА</h2>
	</div>
</section>
<!-- /Section1 -->
<br>
<!-- Section2 -->
<section>
	<h3>ИЗБЕРИ <span class="font-effect-neon">X-BOOKS</span> ИГРА</h3>
	<form action="data.html" name="accessories" method="get">
		<button class="b" type="button">Всички</button>
		<button class="b" type="button">Бързи</button>
		<button class="b" type="button">Приключенски</button>
		<button class="b" type="button">Стратегически</button>
		<button class="b" type="button">Други</button>
	</form>
<br>
	<form action="data.html" name="netbooks" method="get">
	<label for="price">Препоръчани за възраст</label>
	<select id="price" size="1sb">
		<option value="01">Всички</option>
		<option value="02">до 8 години</option>
		<option value="03">от 8 до 16 години</option>
		<option value="04">над 16 години</option>
	</select>
	<p>Подреди по</p>
	<label for="date">Дата на публикуване</label>
	<select id="date" size="1sb">
		<option value="01"></option>
		<option value="02">Нови - Стари</option>
		<option value="03">Стари - Нови</option>
	</select>
	<label for="performance">Популярност</label>
	<select id="performance" size="1sb">
		<option value="01"></option>
		<option value="02">Висока - Ниска</option>
		<option value="03">Ниска - Висока</option>
	</select>
	<label for="rating">Оценка</label>
	<select id="rating" size="1sb">
		<option value="01"></option>
		<option value="02">Висока - Ниска</option>
		<option value="03">Ниска - Висока</option>
	</select>
