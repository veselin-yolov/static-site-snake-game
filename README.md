...
### Записване на точките / НЕ РАБОТИ!!!

Записването на точките става след натискането на бутона **Save scores and time**.

#### Как става записването на точките?

> - От файла *single-player.js* се изпраща AJAX заявка към файла *insert.js* с точките и секундите в момента на натискане на бутона.
>
> - От файла *insert.js* данните се записват в MySQL база данни.
...
> - От файла *single-player.js* се изпраща AJAX заявка към файла *select.js*.
>
> - От файла *select.js* се извеждат данните от таблицата *user_scores* в базата данни.
>
> - Данните се изпращат до файла *single-player.js* и се показват на страницата *single-player.html*.